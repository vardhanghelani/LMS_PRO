...
import {
    BookOpen, Heart, History, User, Bell, RotateCcw, 
                    ...
                    <div className="flex items-center justify-between h-20">
                        ...
                        <div className="flex items-center space-x-4">
                            <div className="flex items-center space-x-4">
                                ...
                                <div>
                                    ...
                                    <p className="text-[#1E293B]/60 text-sm font-medium">Patron Dashboard</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="hidden lg:flex items-center justify-center flex-1">
                            <div className="flex items-center">
                                ...
                                {patronNavItems.map(({ name, href, icon: IconComponent }, index) => {
                                ...
                                {/* Action Buttons */}
                                {/* Notifications */}
                                <Link href="/patron/notifications">
                    ...
                    {mobileMenuOpen && (
                        ...
                        >
                            <div className="px-4 py-6 space-y-2">
                                {patronNavItems.map(({ name, href, icon: IconComponent }) => {
                                    const active = pathname === href || pathname.startsWith(href + '/');
                                    return (
                                        <Link
                                            key={href}
