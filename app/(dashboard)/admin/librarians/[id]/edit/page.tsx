    ...
    useEffect(() => {
        const fetchLibrarian = async () => {
            try {
                ...
                if (data.success && (data.user || data.librarian)) {
                    const librarianData = data.user || data.librarian;
                    ...
                    setError(data.message || 'Failed to fetch librarian details');
                }
            } catch (err) {
                setError('Failed to fetch librarian details');
            } finally {
                setLoading(false);
            }
        };
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            if (data.success) {
                ...
                setError(data.message || 'Failed to update librarian');
            }
        } catch (error) {
            console.error('Error updating librarian:', error);
            setError('Failed to update librarian. Please try again.');
        } finally {
            setSaving(false);
        }
    };
        ...
        return (
            <div className="min-h-screen bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 flex items-center justify-center">
                <div className="text-center">
                    ...
                    <p className="text-slate-300 text-lg">Loading librarian details...</p>
                </div>
            </div>
        );
    }
        ...
        return (
            <div className="min-h-screen bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 flex items-center justify-center">
                ...
                >
                    ...
                    <h2 className="text-2xl font-bold text-white mb-2">Librarian Updated Successfully!</h2>
                    <p className="text-slate-300 mb-4">Redirecting to librarians list...</p>
                </motion.div>
            </div>
        );
    }
            ...
            <div className="max-w-4xl mx-auto">
                ...
                >
                    ...
                    <div className="flex items-center gap-4">
                        ...
                        <div>
                            <h1 className="text-3xl font-bold text-white">Edit Librarian</h1>
                            <p className="text-slate-400">Update librarian information and status</p>
                        </div>
                    </div>
                </motion.div>
